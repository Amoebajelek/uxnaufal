...
import Aitiservecontext from "@/public/Aitiserve_Context.jpg";
        ...
        <div className="flex flex-col w-full lg:w-8/12">
          ...
          <div className="felx felx-col">
            ...
            <div className="flex flex-col gap-4">
              <p className="text-lg text-gray-800 dark:text-gray-500">
                This project will demonstrate my expertise in these three
                crucial domains:
              </p>
            ...
            <div className="flex flex-col gap-4 w-6/8">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-lg text-black dark:text-white">
                  Enhancing the AITISERVE website to meet stakeholder
                  requirements and support the company&apos;s long-term
                  objectives.
                </p>
                ...
                <p className="text-lg text-black dark:text-white">
                  ...
                  platform services, including programming, web portal
                  management, as well as IT consulting and technical support.
                </p>
                <div className="w-full h-fit bg-black dark:bg-gray-100 rounded-3xl lg:rounded-4xl overflow-hidden my-4">
                  <Image
                    src={Aitiservecontext}
                    alt="Aitiserve COntext"
                    width={1600}
                  />
                </div>
                <div className="flex flex-col gap-2">
                  ...
                  <ul className="list-decimal ms-8 text-lg text-black dark:text-white space-y-1">
                    ...
                    <li>
                      ...
                      Highlights legacy projects that demonstrate
                      AITISERVE&apos;s capabilities and experience.
                    </li>
                    <li>
                      <span className="font-medium">Blogs</span> : Allows users
                      to explore articles, insights, and knowledge shared by our
                      team.
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      current job openings and the benefits of joining
                      AITISERVE.
                    </li>
                    <li>
              ...
              <div className="flex flex-col">
                ...
                <p className="text-lg text-black dark:text-white">
                  In the redesign process, we applied foundational UX laws—such
                  as Hick&apos;s Law, Fitts&apos;s Law, and the Law of
                  Proximity—to ensure every design decision was backed by
                  human-centered principles. These laws helped streamline user
                  interactions, improve visual hierarchy, and create more
                  intuitive experiences. By grounding our design choices in
                  proven UX principles, we enhanced usability, clarity, and
              ...
              <div className="flex flex-col">
                ...
                <p className="text-lg text-black dark:text-white">
                  The Design Thinking framework was applied systematically
                  through its five key phases: Empathize, Define, Ideate,
                  Prototype, and Test. This approach ensured a deep
                  understanding of user needs, clear problem definition,
                  creative solution generation, iterative prototyping, and
                  continuous validation. By following this user-centered
                  process, we were able to design solutions that are not only
                  functional but also meaningful and relevant to real user
                  challenges.
                </p>
              </div>
