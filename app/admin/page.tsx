      ...
      <section>
        ...
        {loadingP ? (
          ...
          >
            ...
            <Link href="/admin/portfolio/new" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold" style={{ backgroundColor: "var(--accent)", color: "#0a0a0a" }}>
            ...
            {projects.map((p, i) => (
              ...
              >
                ...
                <div className="col-span-3 flex items-center justify-end gap-2">
                  ...
                  <Link href={`/admin/portfolio/${p.id}`} className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium border transition-all hover:opacity-80" style={{ borderColor: "var(--border-strong)", color: "var(--text-secondary)" }}>
                    <Pencil size={11} /> Edit
                  </Link>
                  <button
