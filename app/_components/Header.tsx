  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6 bg-gray-100">
      <div className="flex gap-0 lg:gap-8 mt-32">
        <h1 className="text-6xl md:text-8xl lg:text-9xl font-extrabold lg:font-bold text-black mb-4">
          HI! I&apos;M NAUFAL
        </h1>
      ...
      <h1 className="text-6xl md:text-8xl lg:text-9xl font-extrabold lg:font-bold text-black mb-8 lg:mb-32">UI/UX DESIGNER</h1>
